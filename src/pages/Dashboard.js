...
import Campaign from "../components/CreateCamp";
...
const Dashboard = () => {
  ...
  const handleCloseCamp = () => setCampShow(false);
  const handleShowCamp = () => setCampShow(true);
  ...
  return (
    <section className="dashboard">
      ...
      <Campaign show={campshow} handleClose={handleCloseCamp} action={'Create'} data={{}} />
      ...
      <div className="dashboard-nav">
        <div>
          ...
          <ul className="dashboard-link" onClick={handleOnClick}>
            ...
            <li>
              <img src="" alt="" />
              <NavLink to="/dashboard/all-casestudy">All CaseStudy</NavLink>
            </li>
          </ul>
        </div>
        <button className="custom-btn" onClick={handleShowCamp}>
          + Campaign
        </button>
      ...
      <div className="dashboard-content">
        <Container fluid>
          ...
          <Row>{!redirectToHome ? <Outlet /> : <Navigate to="/" />}</Row>
        </Container>
      </div>
    </section>
  );
